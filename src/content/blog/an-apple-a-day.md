...
_[Abusing glibc Wide-Mode I/O and FILE Structure Corruption for Reliable Code Execution]_
...
While researching heap exploitation techniques and going through various "House of \_\_\_\_" exploits, I found that [**House of Apple 2**](https://bbs.kanxue.com/thread-273832.htm) matched perfectly with what this challenge required.
...
This is the most important step of the whole exploit. Until now, we’ve only _prepared_ our fake FILE structure. Now we force glibc to actually **use it**.
...
- when `exit()` is called, glibc will process _our_ FILE
